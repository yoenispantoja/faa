...
module.exports = "<div [@routerTransition]>\n    <app-page-header [heading]=\"'Detalles del sancionado'\" [icon]=\"'fa-user'\"></app-page-header>\n\n    <div class=\"row\">\n        <div class=\"col-lg-12\">\n            <div class=\"card mb-3\">\n                <div class=\"card-header\"><b>Ficha personal</b><span class=\"pull-right btn badge badge-secondary\" (click)=\"ExportarFicha(sancionado.id)\"><i class=\"fa fa-file-pdf-o\" aria-hidden=\"true\"></i> Exportar</span></div>\n                <div class=\"card-body\">\n                    <div class=\"row\">\n                        <div class=\"col-sm-4\">\n                            <img [src]=\"foto\" alt=\"\" class=\"rowSancionado\" width=\"200px\" height=\"200px\">\n                        </div>\n                        <div class=\"col-sm-8\">\n                            <div *ngIf=\"sancionado\">\n                                <br><br>\n                                <h5><i class=\"fa fa-user\" aria-hidden=\"true\"></i> <span class=\"text-primary\"> Nombre y apellidos: </span>{{sancionado.nombre_completo}}</h5>\n                                <h5><i class=\"fa fa-users\" aria-hidden=\"true\"></i> <span class=\"text-primary\"> Grupo docente: </span>{{sancionado.grupo}}</h5>\n                                <h5><i class=\"fa fa-credit-card\" aria-hidden=\"true\"></i> <span class=\"text-primary\"> Solapín: </span>{{sancionado.solapin}}</h5>\n                                <h5><i class=\"fa fa-fire\" aria-hidden=\"true\"></i> <span class=\"text-primary\"> Cantidad de sanciones: </span><span class=\"badge badge-info\">{{indisciplinas.length}}</span></h5>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <hr>\n                            <h4>Relación de indisciplinas cometidas</h4>\n                            <div *ngIf=\"indisciplinas\" class=\"table-responsive\">\n                                <table class=\"table table-bordered table-striped table-hover display nowrap\" width=\"100%\">\n                                    <thead>\n                                        <tr>\n                                            <th class=\"text-primary\"><i class=\"fa fa-calendar\" aria-hidden=\"true\"></i> Fecha</th>\n                                            <th class=\"text-primary\"><i class=\"fa fa-filter\" aria-hidden=\"true\"></i> Categoría</th>\n                                            <th class=\"text-primary\"><i class=\"fa fa-user-secret\" aria-hidden=\"true\"></i> Clasificación</th>\n                                            <th class=\"text-primary\"><i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i> Descripción</th>\n                                            <th></th>\n                                        </tr>\n                                    </thead>\n                                    <tbody>\n                                        <tr *ngFor=\"let indisciplina of indisciplinas\">\n                                            <td>{{indisciplina.fecha | date}}</td>\n                                            <td *ngIf=\"categorias\">{{getCategoria(indisciplina.id_categoria)}}</td>\n                                            <td>{{indisciplina.clasificacion}}</td>\n                                            <td>{{indisciplina.descripcion}}</td>\n                                            <td><button type='button' id='btnDetalles' (click)='VerIndisciplina(indisciplina.id)' class='btn btn-sm btn-danger btn-detail' title='Ver detalles'><i class='fa fa-eye vermas'></i></button></td>\n                                        </tr>\n                                    </tbody>\n\n                                </table>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n\n</div>"
...
var SancionadoDetallesComponent = /** @class */ (function () {
    ...
    SancionadoDetallesComponent.prototype.VerIndisciplina = function (idIndisciplina) {
